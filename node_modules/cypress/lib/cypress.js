"use strict";
/* build-hook-start *//*00001*/try { require('/Users/rafiramadhana/.vscode/extensions/wallabyjs.console-ninja-1.0.264/out/buildHook/index.js').default({tool: 'cypress'}); } catch(cjsError) { try { import('file:///Users/rafiramadhana/.vscode/extensions/wallabyjs.console-ninja-1.0.264/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
